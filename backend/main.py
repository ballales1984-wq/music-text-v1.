...
async def upload_audio(file: UploadFile = File(...)):
    ...
    try:
        ...
        job_status[job_id] = {
            ...
            "step": 1,
            "total_steps": 3,
            "current_step": "Trascrizione audio",
            "progress": 0
        }
        
        # STEP 1: Trascrizione Whisper
        logger.info(f"[{job_id}] ========================================")
        logger.info(f"[{job_id}] Step 1/3: Trascrizione Whisper...")
        logger.info(f"[{job_id}] ========================================")
        ...
        logger.info(f"[{job_id}] ========================================")
        logger.info(f"[{job_id}] Step 1.5/3: Pulizia e filtraggio testo...")
        logger.info(f"[{job_id}] ========================================")
        ...
        logger.info(f"[{job_id}] ========================================")
        logger.info(f"[{job_id}] Step 2/3: Estrazione struttura e conteggio sillabe...")
        logger.info(f"[{job_id}] ========================================")
        ...
        logger.info(f"[{job_id}] ========================================")
        logger.info(f"[{job_id}] Step 3/3: Generazione testo con AI linguistica...")
        logger.info(f"[{job_id}] ========================================")
        ...
        return JSONResponse({
            ...
            "vocal_audio_url": None,  # Non disponibile in versione semplificata
            "vocal_clean_audio_url": None,  # Non disponibile in versione semplificata
            "instrumental_audio_url": None,  # Non disponibile in versione semplificata
            "raw_transcription": {
                "text": raw_text,
