        ...
        if use_metric_grid:
            try:
                ...
                if grid_lines:
                    ...
                    full_text_cleaned = clean_generated_text("\n".join(grid_lines))
                    grid_lines_cleaned = [line.strip() for line in full_text_cleaned.split('\n') if line.strip()]
                    
                    if not grid_lines_cleaned:
                        grid_lines_cleaned = grid_lines  # Fallback se pulizia rimuove tutto
