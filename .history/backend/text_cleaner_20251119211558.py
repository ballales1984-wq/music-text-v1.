...
def clean_generated_text(text: str) -> str:
    ...
    # 7. Correggi parole spezzate comuni (prima di tutto, prima delle altre pulizie)
    ...
    # 8. Rimuovi ripetizioni di frasi molto corte (1-3 parole) ripetute più di 2 volte
    words = text.split()
    if len(words) > 0:
        cleaned_words = []
        seen_phrases = {}
