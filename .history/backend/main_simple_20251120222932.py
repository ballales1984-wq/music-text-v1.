...
def process_audio_simple(job_id: str, input_path: Path):
    ...
    try:
        ...
        # STEP 4: Pulizia testo trascritto (senza inventare frasi nuove)
        update_status(job_id, 3, 3, "Pulizia trascrizione (senza generazione creativa)...", 90)
        logger.info(f"[{job_id}] Step 4: Pulizia trascrizione (no AI creativa)...")
