  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      if (err.code === 'ECONNREFUSED' || err.message?.includes('Network Error')) {
        ...
        // Timeout solo durante upload - il processamento continua in background
        if (currentJobId) {
          errorMessage = 'Timeout durante upload, ma il processamento continua in background. Controlla il progresso qui sotto.'
          // Continua polling anche se c'è stato timeout
          setLoading(true)
        } else {
          errorMessage = 'Timeout durante upload. Riprova con un file più piccolo o verifica la connessione.'
        }
